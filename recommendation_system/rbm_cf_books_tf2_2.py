...
scored_books_df_mock = scored_books_df_mock.assign(RecommendationScore=rec[0])

books_df_mock = ratings_df[ratings_df['ID'] == mock_user_id]
...
result = merged_df_mock.sort_values(["RecommendationScore"], ascending=False).head(20)
result = result.loc[:, ['Name_x', 'Id', 'RecommendationScore']]
print(result)
